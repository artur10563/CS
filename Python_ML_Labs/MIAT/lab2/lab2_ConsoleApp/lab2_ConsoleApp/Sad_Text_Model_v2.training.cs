...
{
    public partial class Sad_Text_Model_v2
    {
        public const string RetrainFilePath =  @"F:\ASP.NET Projects\CS\Python_ML_Labs\MIAT\lab2\lab2_ConsoleApp\lab2_ConsoleApp\testData2.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=4,MinimumExampleCountPerLeaf=20,LearningRate=0.9037627412653618,LabelColumnName=@"col1",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.99999999,L1Regularization=2E-10,L2Regularization=0.9999997766729865},MaximumBinCountPerFeature=212}))      
